#!/usr/bin/env python3
"""
Enhanced AI Assistant with Hugging Face transformers (CPU-only, no PyTorch models)
Using transformers library for improved tokenization and NLP features
"""
...
# Configure Enhanced AI system with Hugging Face tokenization
try:
    print("🤗 Loading Hugging Face tokenizer...")
    
    # Use a lightweight tokenizer for better text processing
    tokenizer = AutoTokenizer.from_pretrained("distilbert-base-uncased")
    
    print("🧠 Initializing Enhanced Smart AI Assistant...")
    
    # Enhanced response patterns with better context understanding
    ENHANCED_RESPONSES = {
        'questions': {
            'what': {
                'technology': [
